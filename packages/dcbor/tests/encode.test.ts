...
describe('encode tests', () => {
  ...
  test('test_normalized_string', () => {
    ...
    expect(() => decodeCbor(cborDataNonCanonical)).toThrow(/Unicode Canonical Normalization Form C/i);
  });
  ...
  describe('encode_float', () => {
    ...
    test('subnormals and special values', () => {
      testCbor(5.960464477539063e-8, 'simple(5.960464477539063e-8)', '5.960464477539063e-8', 'f90001');
    ...
    test('large negative conversions', () => {
      testCborDecode('3b8000000000000000', 'negative(-9223372036854775809)', '-9223372036854775809');
      testCborDecode('3bfffffffffffffffe', 'negative(-18446744073709551615)', '-18446744073709551615');
    });
  });
